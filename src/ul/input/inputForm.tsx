...
const InputForm:FC<Props> = ({id, name, Ref, type, placeholder, fullName, textarea = false}) => {
    ...
    return (
        <div className="mb-4">
          ...
          {textarea ? 
            <textarea className='bg-transparent border-b border-white50 text-white w-3/4 focus:outline-none placeholder:text-white50' id={id} required placeholder={placeholder} ref={Ref} /> : 
